...
// ══════════════════════════════════════════════════════════
// PEGAR AL FINAL DE shared.js
// Supabase pacientes — cache compartido por citas, historial y sala-espera
// ══════════════════════════════════════════════════════════
const _SB_URL  = 'https://bhawfcvnthzdwmkgwgxj.supabase.co';
const _SB_ANON = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJoYXdmY3ZudGh6ZHdta2d3Z3hqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODA0MzY4MjUsImV4cCI6MjA5NjAxMjgyNX0.gpaCKHr2HqAg7k0Zb4VolKWNEZvBrgE7Y2bJuL27PYc';

let _pacientesCache = null;

async function fetchPacientesSupabase() {
  const res = await fetch(`${_SB_URL}/rest/v1/pacientes?select=*`, {
    headers: {
      'apikey':        _SB_ANON,
